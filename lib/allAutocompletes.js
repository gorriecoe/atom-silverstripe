  ...
  for (let name in object) {
    ...
    if (options.variations) {
      for (let key in options.variations) {
        ...
        buildAutoComplete({
          snippet: variation.body ? variation.body : options.body,
          ...
          useNamespace: variation.useNamespace ? variation.useNamespace : options.useNamespace,
        })
      }
    } else {
      buildAutoComplete({
...
var buildAutoComplete = function ({snippet, definitions, name, prefix, scopes, module, minVersion, maxVersion, description, url, useNamespace}) {
